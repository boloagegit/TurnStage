...
async function runCliSmoke(workspace) {
  ...
  if (parsed?.summary?.attackSucceeded !== 1 || parsed?.summary?.resisted !== 1 || parsed?.summary?.passed !== 1) throw new Error(`Headless CLI did not execute the expected JSONC, CSV, and contract mock cases: ${result.stdout}`);
